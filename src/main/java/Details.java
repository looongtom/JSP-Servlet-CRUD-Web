...
//            Statement stmt = conn.createStatement();
            String sql ="select orders.order_id,orders.order_name,staff.first_name,staff.last_name,staff.staff_id,orders.order_price from orders inner join staff on orders.staff_id=staff.staff_id WHERE staff.staff_id = ?";
